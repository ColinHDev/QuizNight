...
export default function ChangeGrid() {
    ...
    return (
        <div>
            ...
            <button className="bg-blue-500 hover:bg-blue-700 disabled:bg-blue-200 text-white font-bold py-2 px-4 rounded" disabled={rightArrowDisabled} onClick={() => globalContext.setCurrentRound(globalContext.currentRound + 1)}>{">"}</button>
        </div>
    )
}
